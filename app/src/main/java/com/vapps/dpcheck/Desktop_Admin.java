...
import com.vapps.dpcheck.Assign_Staff;
import com.vapps.dpcheck.DatabaseHelper;
import com.vapps.dpcheck.Delete_Users;
import com.vapps.dpcheck.Personal_Info;
    ...
    public void onClick(View view){
        ...
        switch (view.getId())
        {
            ...
            case R.id.b_da_patient_appointment:
                i = new Intent(Desktop_Admin.this, com.vapps.dpcheck.Desktop_Admin.Grant_appointment.class);
                break;
            case R.id.b_da_remaining_bills:
                i = new Intent(Desktop_Admin.this, com.vapps.dpcheck.Desktop_Admin.Remaining_patient_bills.class);
                break;
